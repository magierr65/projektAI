...
def run_modular_training(df):
    ...
    plot_hourly_mape(mape_vector, model_name, title='Modular: Hourly MAPE')
    plot_hourly_predictions_comparison(y_true_24h, Pi_vector, model_name, title='Modular: Actual vs. Predicted Load')
...
if __name__ == '__main__':
    ...
    run_modular_training(df_processed)
